---
title: "Hermes Upstream Audit — Audit upstream Hermes issues and PRs before repairs"
sidebar_label: "Hermes Upstream Audit"
...
Audit upstream Hermes issues and PRs before repairs.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/software-development/hermes-upstream-audit` |
| Path | `optional-skills/software-development/hermes-upstream-audit` |
| Version | `0.1.0` |
| Author | Mike DeMott (mrkillbob), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `Hermes`, `GitHub`, `Issues`, `Pull Requests`, `Root Cause`, `Maintenance` |
| Related skills | [`github`](../../bundled/software-development/software-development-github.md), [`systematic-debugging`](../../bundled/software-development/software-development-systematic-debugging.md), [`requesting-code-review`](../../bundled/software-development/software-development-requesting-code-review.md) |
