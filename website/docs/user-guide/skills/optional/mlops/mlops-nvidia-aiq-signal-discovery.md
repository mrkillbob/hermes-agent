---
title: "Nvidia Aiq Signal Discovery — Run governed NVIDIA signal research for LunaBot"
sidebar_label: "Nvidia Aiq Signal Discovery"
description: "Run governed NVIDIA signal research for LunaBot"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# Nvidia Aiq Signal Discovery

Run governed NVIDIA signal research for LunaBot.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/mlops/nvidia-aiq-signal-discovery` |
| Path | `optional-skills/mlops/nvidia-aiq-signal-discovery` |
| Version | `0.1.0` |
