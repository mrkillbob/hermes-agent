---
title: "Engineering Memory — Review and search shared engineering evidence"
sidebar_label: "Engineering Memory"
...
Review and search shared engineering evidence.
...
| Path | `skills/software-development/engineering-memory` |
| Version | `1.0.0` |
| Author | Mike DeMott (@mrkillbob), Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `engineering`, `memory`, `provenance`, `review`, `diagnostics` |
| Related skills | [`codebase-inspection`](../../bundled/software-development/software-development-codebase-inspection.md), [`systematic-debugging`](../../bundled/software-development/software-development-systematic-debugging.md) |
