...
def test_anthropic_read_file_result_is_elided_on_unprotected_route(tmp_path):
    """Exact read_file call ids keep Anthropic's scalar result out of generic egress scans."""
