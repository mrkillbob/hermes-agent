    ...
    if posix_group_kill:
        try:
            ...
            if pgid == pid and pgid != os.getpgrp():
                os.killpg(pgid, sig)  # windows-footgun: ok — inside POSIX process-group ownership gate
                return
        except ProcessLookupError:
            ...
            if pid != os.getpgrp():
                try:
                    os.killpg(pid, sig)  # windows-footgun: ok — inside POSIX process-group ownership gate
                    return
