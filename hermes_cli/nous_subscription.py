...
_FEATURES: Dict[str, _FeatureSpec] = {
    "web": _FeatureSpec(
        ...
        "Web search & extract (Firecrawl)", "Firecrawl/Exa/Parallel/Tavily/Keenable key or SearXNG",
...
def _web_feature(web_cfg: Dict[str, object], tool_enabled: bool, managed: bool, web_gw: bool, direct_firecrawl: bool) -> NousFeatureState:
    ...
    active = web_managed or direct.get(backend) or direct.get(search_backend) or (extract_backend == "tavily" and direct[extract_backend])
    return _state(
