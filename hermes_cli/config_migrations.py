...
MIGRATIONS: Tuple[Tuple[int, Callable[[Dict[str, Any], bool], None]], ...] = (
    ...
    (41, _migrate_to_41),
    # 41 → 42: renumbered on merge — both branches independently claimed v41
    # (main: _migrate_to_41, this branch: _migrate_conversation_worktree_policy).
    # main's step keeps v41; this one moves to v42 to stay strictly ascending.
