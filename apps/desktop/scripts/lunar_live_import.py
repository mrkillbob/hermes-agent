...
FOLDER = ROOT / 'public/lunar-city/multiview-2026-09-07'
ASSETS = ('owl-librarian', 'elephant-memory', 'cat-arts', 'fox-scientist',
          'capybara-revenue', 'lion-steward', 'beaver-architect', 'monkey-poet')
WORKSHOP = FOLDER / 'leader-workshop.blend'
...
print('Lunar live import queue registered for eight leaders.')
