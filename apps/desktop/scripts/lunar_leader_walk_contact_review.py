...
assets=['owl-librarian','elephant-memory','fox-scientist','capybara-revenue','lion-steward','beaver-architect']
results=[]
for asset in assets:
 ...
 (ROOT/'walk-contact-batch-status.json').write_text(json.dumps(results,indent=2)+'\n')
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/'leader-rig-workshop.blend'))
print('Six preserved walk contact candidates saved',results)
