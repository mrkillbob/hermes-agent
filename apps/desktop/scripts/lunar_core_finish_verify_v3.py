...
source=bpy.data.scenes['Worker static finish | core v3 probe'];scene=bpy.data.scenes.new('Worker GLB verification | core v3');scene.world=source.world.copy();scene.unit_settings.system='METRIC';scene.unit_settings.scale_length=1;bpy.context.window.scene=scene
