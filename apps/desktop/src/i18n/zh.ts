...
export const zh: Translations = {
  ...
  lunarCity: {
    disabled: '世界已禁用',
    disabledHint: '在设置 → 插件中启用世界，即可再次使用月城。',
    label: '月城',
    worldAriaLabel: '月城世界',
    heading: '你的 Hermes 世界',
    intro: 'Hermes 工作、代理、提醒和庆祝活动的生动界面。每个操作都与真实系统保持连接。',
    selectSubject: '选择工作单元、负责人、任务或事件，打开世界内对话。',
    defaultsActive: 'Hermes 默认设置已启用',
    starterAssets: '内置宠物和初始资产已准备就绪。',
    assetCompanions: 'Hermes 宠物伙伴',
    assetScene: '月城初始场景',
    assetTextures: '内置纹理和道具',
    localAssets: '本地资产',
    localAssetsForReview: '供审核的本地资产',
    reviewOnly: '仅供审核 — 文件留在此窗口中；未连接导入器。',
    worldSetup: '月城世界设置',
    worldSetupDescription: '使用 Hermes 内置宠物和资产开始，或暂存本地文件以供审核。',
    builtInPets: 'Hermes 内置宠物和资产',
    builtInPetAlt: 'Hermes 内置宠物',
    safeDefault: '安全默认设置已就绪；文件不会离开此设备。',
    dropLocalAssets: '放置本地世界资产',
    dropToStage: '放置以供审核',
    formats: 'GLB、GLTF、PNG、JPG 或 WEBP',
    stagedFiles: count => `仅供审核 — 已暂存 ${count} 个本地文件；未连接导入器。`,
    skip: '暂时跳过',
    useDefaults: '使用 Hermes 默认设置',
    dialogue: {
      ariaLabel: title => `对话：${title}`,
      label: '世界内对话',
      close: '关闭对话',
      source: '来源',
      state: '状态',
      severity: '严重性',
      task: '任务',
      detailUnavailable: '没有更多来源详情。',
      role: role => `角色：${role}`,
      assignedTo: assignee => `分配给：${assignee}`,
      actionUnavailable: '当前 Hermes 状态不支持此操作。',
      actionAccepted: 'Hermes 已接受此操作。',
      inspectBlocker: '检查阻塞原因',
      inspect: '检查',
      recover: '解除阻塞 / 恢复'
    },
    dispatcher: {
      ...
      cube: '调度方块',
      commandCenter: '命令中心',
      description: '通过城市与 Hermes 对话。',
      newTask: '新建任务',
      newSession: '新建会话',
      attention: '什么需要我关注？',
      recentEvents: 'Hermes 最近事件',
      recentActivity: '最近活动',
      createTask: '创建 Kanban 任务',
      title: '标题',
      brief: '简述',
      sending: '正在发送到 Hermes…',
      dispatch: '派发任务',
      startPrompt: '要在当前桌面环境中开始新的 Hermes 对话吗？',
      starting: '正在开始…',
      startSession: '开始会话',
      activeConditions: count => `${count} 个活跃世界条件`,
      recentEventsCount: count => `${count} 个最近来源事件`,
      report: '情况报告',
      openReport: '打开报告',
      taskRequired: '需要填写任务标题。'
    },
    scene: {
      ariaLabel: '月城场景',
      liveProjection: '实时世界投影',
      colonyNetwork: 'Hermes 殖民地网络',
      stale: '来源已过期',
      connected: '已连接',
      baselineAriaLabel: '基准 3D 场景',
      authoredAssets: (count, profile) => `${count} 个基准资产 · ${profile}`,
      assetDetail: (kind, collection, role, lods) => `${kind}资产，位于${collection}。角色：${role}。LOD：${lods}。`,
      sceneObject: name => `场景对象：${name}`,
      downloadScene: '下载 3D 场景',
      downloadRoster: '下载类别名单',
      npcActivity: 'NPC 活动',
      quiet: '殖民地很安静。新的 Hermes 工作出现时会显示在这里。',
      recentEvents: '最近世界事件',
      status: '殖民地状态',
      conditions: '条件',
      events: '事件',
      recapAriaLabel: '世界回顾',
      whileAway: '你离开期间',
      transitions: count => `有 ${count} 个 Hermes 状态变化需要你关注。`
    },
    glb: {
      canvasAriaLabel: '可交互的月城 3D 场景',
      imageAlt: '具有地面道路和凹形地形的月城 Blender 基准场景'
    }
  },
  agents: {
