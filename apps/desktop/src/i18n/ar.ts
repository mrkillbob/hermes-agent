...
export const ar = defineLocale({
  ...
  lunarCity: {
    disabled: 'العالم معطّل',
    disabledHint: 'فعّل العالم من الإعدادات ← الإضافات لإتاحة مدينة القمر مجددًا.',
    label: 'مدينة القمر',
    worldAriaLabel: 'عالم مدينة القمر',
    heading: 'عالم Hermes الخاص بك',
    intro: 'واجهة حيّة لأعمال Hermes ووكلائه وتنبيهاته واحتفالاته. يظل كل إجراء متصلًا بالنظام الحقيقي.',
    selectSubject: 'اختر عاملًا أو قائدًا أو مهمة أو حدثًا لفتح الحوار داخل العالم.',
    defaultsActive: 'إعدادات Hermes الافتراضية مفعّلة',
    starterAssets: 'تتوفر الحيوانات الأليفة والأصول المبدئية المضمّنة.',
    assetCompanions: 'رفقاء Hermes الأليفون',
    assetScene: 'المشهد المبدئي لمدينة القمر',
    assetTextures: 'الخامات والعناصر المضمّنة',
    localAssets: 'الأصول المحلية',
    localAssetsForReview: 'أصول محلية للمراجعة',
    reviewOnly: 'للمراجعة فقط — تبقى الملفات في هذه النافذة ولا يوجد مستورد متصل.',
    worldSetup: 'إعداد عالم مدينة القمر',
    worldSetupDescription: 'ابدأ بالحيوانات والأصول المضمّنة في Hermes، أو جهّز ملفات محلية للمراجعة.',
    builtInPets: 'حيوانات Hermes وأصوله المضمّنة',
    builtInPetAlt: 'حيوان Hermes الأليف المضمّن',
    safeDefault: 'الإعداد الافتراضي الآمن جاهز الآن؛ لا تغادر الملفات هذا الجهاز.',
    dropLocalAssets: 'أفلت أصول العالم المحلية',
    dropToStage: 'أفلتها لتجهيزها للمراجعة',
    formats: 'GLB أو GLTF أو PNG أو JPG أو WEBP',
    stagedFiles: count => `للمراجعة فقط — تم تجهيز ${count} من الملفات المحلية؛ لا يوجد مستورد متصل.`,
    skip: 'تخطَّ الآن',
    useDefaults: 'استخدم إعدادات Hermes الافتراضية',
    dialogue: {
      ariaLabel: title => `حوار: ${title}`,
      label: 'حوار داخل العالم',
      close: 'إغلاق الحوار',
      source: 'المصدر',
      state: 'الحالة',
      severity: 'الخطورة',
      task: 'المهمة',
      detailUnavailable: 'لا تتوفر تفاصيل إضافية عن المصدر.',
      role: role => `الدور: ${role}`,
      assignedTo: assignee => `مُسندة إلى: ${assignee}`,
      actionUnavailable: 'لا يتوفر هذا الإجراء في حالة Hermes الحالية.',
      actionAccepted: 'قبل Hermes الإجراء.',
      inspectBlocker: 'فحص العائق',
      inspect: 'فحص',
      recover: 'إزالة العائق / استعادة'
    },
    dispatcher: {
      companion: 'مساعد الموزّع',
      cube: 'مكعّب الموزّع',
      commandCenter: 'مركز الأوامر',
      description: 'تحدّث مع Hermes عبر المدينة.',
      newTask: 'مهمة جديدة',
      newSession: 'جلسة جديدة',
      attention: 'ما الذي يحتاج إلى انتباهي؟',
      recentEvents: 'أحداث Hermes الأخيرة',
      recentActivity: 'النشاط الأخير',
      createTask: 'إنشاء مهمة Kanban',
      title: 'العنوان',
      brief: 'موجز',
      sending: 'جارٍ الإرسال إلى Hermes…',
      dispatch: 'إرسال المهمة',
      startPrompt: 'هل تريد بدء محادثة Hermes جديدة في سياق سطح المكتب الحالي؟',
      starting: 'جارٍ البدء…',
      startSession: 'بدء الجلسة',
      activeConditions: count => `${count} من شروط العالم النشطة`,
      recentEventsCount: count => `${count} من أحداث المصدر الأخيرة`,
      report: 'تقرير الحالة',
      openReport: 'فتح التقرير',
      taskRequired: 'عنوان المهمة مطلوب.'
    },
    scene: {
      ariaLabel: 'مشهد مدينة القمر',
      liveProjection: 'إسقاط العالم المباشر',
      colonyNetwork: 'شبكة مستعمرة Hermes',
      stale: 'مصدر قديم',
      connected: 'متصل',
      baselineAriaLabel: 'مشهد ثلاثي الأبعاد أساسي',
      authoredAssets: (count, profile) => `${count} من الأصول الأساسية المؤلّفة · ${profile}`,
      assetDetail: (kind, collection, role, lods) =>
        `أصل ${kind} في ${collection}. الدور: ${role}. مستويات التفاصيل: ${lods}.`,
      sceneObject: name => `كائن المشهد: ${name}`,
      downloadScene: 'تنزيل المشهد ثلاثي الأبعاد',
      downloadRoster: 'تنزيل قائمة الفئة',
      npcActivity: 'نشاط الشخصيات غير اللاعبة',
      quiet: 'المستعمرة هادئة. سيظهر عمل Hermes الجديد هنا عند حدوثه.',
      recentEvents: 'أحداث العالم الأخيرة',
      status: 'حالة المستعمرة',
      conditions: 'الشروط',
      events: 'الأحداث',
      recapAriaLabel: 'ملخص العالم',
      whileAway: 'أثناء غيابك',
      transitions: count => `هناك ${count} من انتقالات Hermes تحتاج إلى انتباهك.`
    },
    glb: {
      canvasAriaLabel: 'مشهد مدينة القمر التفاعلي ثلاثي الأبعاد',
      imageAlt: 'مشهد Blender الأساسي لمدينة القمر بطرقات مثبتة وتضاريس مقعّرة'
    }
  },
  agents: {
